...
switch(getParam('types'))   // 根据请求的 Api，执行相应操作
{
    ...
    default:
        if(!defined('DEBUG') || DEBUG !== true) {   // 非调试模式
            ...
            echo '<!doctype html><html><head><meta charset="utf-8"><title>信息</title><style>* {font-family: microsoft yahei}</style></head><body> <h3>MKOnlinePlayer</h3><p><font color="red">您已开启 Api 调试功能，正常使用时请在 api.php 中关闭该选项！</font></p><br>';
