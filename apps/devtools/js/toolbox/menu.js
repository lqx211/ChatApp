...
;(function($) {
	...
	var menu = {
		...
		'menu_three' : {
				...
				'sha:Rabbit_Decrypt':'Rabbit_Decrypt', 'sha:RC4_Encrypt':'RC4_Encrypt', 'sha:RC4_Decrypt':'RC4_Decrypt','crc32:1':'CRC32'
			},
		'menu_four': {
		...
		'menu_five': {
			...
			'codeview:1': '代码调试预览', 'regular:1': '正则表达式', 
		},
		'menu_six': {
			'qrcode:1': '漂亮二维码', 'qrcode_reader:1': '识别二维码', 'contrast:1': '常用对照表',
			...
			'websafecolors:1':'WEB 安全色', 'http:1': 'HTTP Request', 'expression:1': '计算表达式',
			'ua:1': 'UserAgent', 'lbs:1': '经纬度计算距离', 'pintu:1':'拼图 - 表单工具','webforms':'WebForms'
		}
	}
