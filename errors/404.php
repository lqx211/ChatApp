...
h1{font-size:1.6em;font-weight:600;color:#e0a040;margin-bottom:12px;word-wrap:break-word}
...
<div class="error-wrapper">
    ...
    <h2><?php echo t('errorpage_not_found'); ?></h2>
    ...
    <details class="error-detail">
        ...
        <p><?php echo t('errorpage_check_url'); ?></p>
    </details>
